...
export const portfolioCopy = {
      ...
      items: [
        {
          ...
          description: "High-impact thumbnail design focused on clarity, personality, and faster visual recognition.",
        ...
        },
        {
          name: "Jotinha TV",
          category: "YouTube Thumbnails",
          description: "Expressive thumbnail visuals crafted to make content feel clickable, memorable, and consistent.",
  ...
  pt: {
    ...
    designWork: {
      eyebrow: "Design Work",
      title: "Thumbnails de YouTube e materiais visuais criados para chamar atencao.",
      visit: "Ver canal",
      items: [
        {
          name: "Rique Paiva",
          category: "Thumbnails de YouTube",
          description: "Design de thumbnails de impacto, com foco em clareza, personalidade e reconhecimento visual rapido.",
          url: "https://www.youtube.com/@CanalDoRique7/videos",
          tone: "red",
        },
        {
          name: "Jotinha TV",
          category: "Thumbnails de YouTube",
          description: "Visuais expressivos para thumbnails, pensados para tornar o conteudo mais clicavel, memoravel e consistente.",
          url: "https://www.youtube.com/@JotinhaTV_/videos",
          tone: "gold",
        },
      ],
